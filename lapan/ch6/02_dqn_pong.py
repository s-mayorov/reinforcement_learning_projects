...
def calc_loss(batch, net, tgt_net, device="cpu"):
    ...
    next_states_v = torch.tensor(np.array(new_states, copy=False)).to(device)
    ...
    return nn.MSELoss()(state_action_values_v, expected_state_action_values)
    ...
    while True:
        ...
        if reward is not None:
            ...
            if best_m_reward is None or best_m_reward < m_reward:
                torch.save(net.state_dict(), f"{args.env}-best_{m_reward}.dat")
